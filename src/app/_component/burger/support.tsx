// src/app/_component/burger/X.tsx
import { SVGProps } from "react";

// コンポーネント名はそのままにして、中身を吹き出しアイコンSVGに置き換えます
export function IconParkTwotoneBigX(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      width="1em"
      height="1em"
      fill="currentColor" // 親要素の文字色を継承するようにcurrentColorを設定
      {...props}
    >
      {/* Font Awesome Freeの吹き出しアイコン (fa-comment-dots / Regular) のパスデータ */}
